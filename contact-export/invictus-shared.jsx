...
const Nav = ({ active = "accueil" }) => {
  ...
  const links = [
    ...
    { id: "events", label: "Événements", href: "Invictus Evenements.html" },
    ...
    <nav className={`nav ${scrolled ? "scrolled" : ""}`}>
      <div className="nav-inner">
        <a className="logo" href="Invictus Accueil.html">
          ...
          <span className="logo-word" style={{ fontFamily: "Lemon Milk" }}>
        ...
        <div className="nav-cta">
          <a href="Invictus Accueil.html#contact" className="btn btn-primary btn-sm" style={{ fontFamily: "Lemon Milk", fontSize: 9 }}>
            Parlons de votre prochain evenement <Icon name="arrow" size={14} stroke={2.2} />
          </a>
        </div>
      </div>
    </nav>
    ...
    <div className="foot-grid">
      <div className="foot-col foot-brand">
        <a className="logo" href="Invictus Accueil.html" style={{ color: "#fff" }}>
          ...
          <span className="logo-word" style={{ fontFamily: "Lemon Milk" }}>INVICTUS<small>AGENCY</small></span>
        </a>
        <p style={{ fontFamily: "Visby CF" }}>Agence événementielle premium 360°. Nous faisons naître des souvenirs qui refusent d'être oubliés.</p>
        <div className="foot-addr">
          <strong>Siège — Abidjan</strong><br />
          Cocody, Abatta Station Ola<br />
          Côte d'Ivoire<br />
          <strong style={{ display: "inline-block", marginTop: 10 }}>+225 07 47 50 93 60</strong>
        </div>
      </div>
      <div className="foot-col">
        <h4 style={{ fontFamily: "Lemon Milk" }}>Navigation</h4>
        <ul>
          <li><a href="Invictus Accueil.html">Accueil</a></li>
          <li><a href="Invictus A Propos.html">À Propos</a></li>
          <li><a href="Invictus Evenements.html">Événements</a></li>
          <li><a href="Invictus Mediatheque.html">Médiathèque</a></li>
          <li><a href="Invictus Accueil.html#contact">Contact</a></li>
        </ul>
      </div>
      <div className="foot-col">
        <h4 style={{ fontFamily: "Lemon Milk" }}>Pôles de compétences</h4>
        <ul>
          <li><a href="#" style={{ fontFamily: "Lemon Milk" }}>BUSINESS WELFARE</a></li>
          <li><a href="#" style={{ fontFamily: "Lemon Milk" }}>ACTIONS COMMUNAUTAIRES</a></li>
          <li><a href="#" style={{ fontFamily: "Lemon Milk" }}>EVENTS PLANNER</a></li>
          <li><a href="#" style={{ fontFamily: "Lemon Milk" }}>MARKETING DE CONTENU</a></li>
        </ul>
      </div>
      <div className="foot-col">
        <h4 style={{ fontFamily: "Lemon Milk" }}>Contact</h4>
        <ul>
